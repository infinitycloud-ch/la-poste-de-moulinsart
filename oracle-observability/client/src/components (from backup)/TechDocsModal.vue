  ...
  <div v-if="isOpen" class="modal-overlay" @click.self="$emit('close')">
    <div class="modal-content">
      ...
      <div class="docs-container">
        ...
        <div class="tmux-shortcuts">
          <h3>⌨️ Raccourcis Tmux Essentiels</h3>
          
          <!-- Commande CRITIQUE en premier -->
          <div class="critical-command">
            <div class="critical-icon">🔴</div>
            <div class="critical-content">
              <strong>ACTIVER LE SCROLL SOURIS/TRACKPAD (Mac):</strong>
              <code>tmux set -g mouse on</code>
              <p>➜ Après cette commande, tu peux scroller directement avec ton trackpad dans tous les panels!</p>
            </div>
          </div>
          ...
          <div class="shortcuts-grid">
            <div class="shortcut-card">
              ...
              <div class="shortcut-item">
                <kbd>Ctrl+B</kbd> <span>puis</span> <kbd>0-3</kbd>
                <p>Aller au panel 0, 1, 2 ou 3</p>
              </div>
              <div class="shortcut-item">
                <kbd>Ctrl+B</kbd> <span>puis</span> <kbd>↑↓←→</kbd>
                <p>Naviguer entre les panels</p>
              </div>
              <div class="shortcut-item">
                <kbd>Ctrl+B</kbd> <span>puis</span> <kbd>z</kbd>
                <p>Zoom/Dézoom sur un panel</p>
              </div>
            </div>
            
            <div class="shortcut-card">
              <div class="shortcut-title">📜 Historique & Scroll</div>
              <div class="shortcut-item">
                <kbd>Ctrl+B</kbd> <span>puis</span> <kbd>[</kbd>
                <p>Mode scroll (copy mode)</p>
              </div>
              <div class="shortcut-item">
                <kbd>↑↓</kbd> ou <kbd>Page Up/Down</kbd>
                <p>Scroller dans l'historique</p>
              </div>
              <div class="shortcut-item">
                <kbd>q</kbd> ou <kbd>Esc</kbd>
                <p>Quitter le mode scroll</p>
              </div>
            </div>
            
            <div class="shortcut-card">
              <div class="shortcut-title">📐 Redimensionnement</div>
              <div class="shortcut-item">
                <kbd>Ctrl+B</kbd> <span>puis</span> <kbd>Espace</kbd>
                <p>Réorganiser automatiquement</p>
              </div>
              <div class="shortcut-item">
                <kbd>Ctrl+B</kbd> <kbd>Alt+1</kbd>
                <p>Layout horizontal égal</p>
              </div>
              <div class="shortcut-item">
                <kbd>Ctrl+B</kbd> <kbd>Alt+2</kbd>
                <p>Layout vertical égal</p>
              </div>
              <div class="shortcut-item">
                <kbd>Ctrl+B</kbd> <kbd>Alt+5</kbd>
                <p>Layout tiled (2x2)</p>
              </div>
            </div>
            
            <div class="shortcut-card">
              <div class="shortcut-title">🎯 Actions Rapides</div>
              <div class="shortcut-item">
                <kbd>Ctrl+B</kbd> <span>puis</span> <kbd>d</kbd>
                <p>Détacher la session</p>
              </div>
              <div class="shortcut-item">
                <kbd>Ctrl+B</kbd> <span>puis</span> <kbd>x</kbd>
                <p>Fermer le panel actuel</p>
              </div>
              <div class="shortcut-item">
                <kbd>Ctrl+C</kbd>
                <p>Arrêter Claude dans un panel</p>
              </div>
              <div class="shortcut-item">
                <kbd>clear</kbd>
                <p>Nettoyer l'écran</p>
              </div>
            </div>
          </div>
          ...
          <div class="tmux-tips">
            <strong>💡 Tips:</strong>
            <ul>
              <li><strong style="color: #e53e3e;">🔴 IMPORTANT:</strong> <code>tmux set -g mouse on</code> - Active le scroll avec trackpad/souris!</li>
              <li>Pour attacher: <code>tmux attach -t moulinsart</code></li>
              <li>Pour lister les sessions: <code>tmux ls</code></li>
              <li>Pour créer layout 2x2: <code>tmux select-layout tiled</code></li>
              <li>Pour capturer l'output: <code>tmux capture-pane -t moulinsart:agents.0 -p</code></li>
            </ul>
          </div>
        </div>
...
@keyframes pulse {
  0% { box-shadow: 0 4px 12px rgba(229, 62, 62, 0.2); }
  50% { box-shadow: 0 4px 20px rgba(229, 62, 62, 0.4); }
  100% { box-shadow: 0 4px 12px rgba(229, 62, 62, 0.2); }
}
