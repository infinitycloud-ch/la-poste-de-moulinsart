    ...
    <div class="modal-content commands-modal">
      ...
      <div class="commands-container">
        <div class="command-section">
          ...
          <div class="command-group">
            <div class="command-item">
              ...
              <code @click="copyCommand('tmux send-keys -t moulinsart-agents:agents.0 C-c Enter')">
            ...
            <div class="command-item">
              ...
              <code @click="copyCommand('tmux send-keys -t moulinsart-agents:agents.1 C-c Enter')">
            ...
            <div class="command-item">
              ...
              <code @click="copyCommand('tmux send-keys -t moulinsart-agents:agents.2 C-c Enter')">
            ...
            <div class="command-item">
              ...
              <code @click="copyCommand('tmux send-keys -t moulinsart-agents:agents.3 C-c Enter')">
          ...
          <div class="command-special">
            ...
            <code @click="copyCommand('for i in {0..3}; do tmux send-keys -t moulinsart-agents:agents.$i C-c Enter; done')">
        ...
        <div class="command-section">
          ...
          <div class="command-group">
            <div class="command-item">
              <code @click="copyCommand(`tmux send-keys -t moulinsart-agents:agents.0 'Votre message' Enter`)">
                tmux send-keys -t moulinsart-agents:agents.0 "Message" Enter
              </code>
              <span class="agent-label">À Nestor</span>
            </div>
            <div class="command-item">
              <code @click="copyCommand(`tmux send-keys -t moulinsart-agents:agents.1 'Votre message' Enter`)">
                tmux send-keys -t moulinsart-agents:agents.1 "Message" Enter
              </code>
        ...
        <div class="command-section">
          ...
          <div class="command-item">
            <code @click="copyCommand('tmux attach -t moulinsart-agents')">
