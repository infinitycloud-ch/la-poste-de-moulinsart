  ...
  <div class="task-board">
    <div class="board-header">
      ...
      <div class="board-controls">
        ...
        <button @click="showCreateTask = true" class="btn-create-task">
          ➕ Create Task
        </button>
        <button @click="showCreatePRD = true" class="btn-create-prd">
          ✍️ Create PRD
        </button>
        <button @click="showPRDSplitter = true" class="btn-split-prd">
          📋 Split PRD
        </button>
      </div>
    </div>
    ...
    <CreatePRDModal
      v-if="showCreatePRD"
      @close="showCreatePRD = false"
      @created="onPRDCreated"
    />

    <!-- PRD Splitter Modal -->
    <PRDSplitterModal
      v-if="showPRDSplitter"
      :projects="projects"
      @close="showPRDSplitter = false"
...
import CreatePRDModal from './CreatePRDModal.vue'
import PRDSplitterModal from './PRDSplitterModal.vue'
...
export default {
  ...
  setup() {
    ...
    const showCreatePRD = ref(false)
    const showPRDSplitter = ref(false)
    ...
    const onTasksCreated = () => {
      showPRDSplitter.value = false
      loadTasks()
      loadTaskStats()
    }

    const onPRDCreated = () => {
      showCreatePRD.value = false
      // Optionally reload PRDs or show a success message
    }
